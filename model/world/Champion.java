...
public abstract class Champion implements Damageable,Comparable {
	...
	private Championlistener championlistener;
	

	public Championlistener getChampionlistener() {
		return championlistener;
	}

	public void setChampionlistener(Championlistener championlistener) {
		this.championlistener = championlistener;
	}
